...
namespace DataSeeder
{
    public class Seeder
    {
        ...
        public void SeedUser()
        {
            ...
            // Specificno dodati korisnik/admin nalog, da ne bi morala da se menja rola u bazi
            ...
            {
                Email = "korisnik@mercedes.com",
                Username = "Korisnik",
                Password = "korisnik12345",
                RoleId = 1,
            };
        ...
        public void SeedComments()
        {
            ...
            var data = comments.Generate(100);
